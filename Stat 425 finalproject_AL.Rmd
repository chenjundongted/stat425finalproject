...
From the cross validation result, the RMSE will be the smallest and the R^2 will be the largest when the number of components is 5.

```{r}
# Predict the testing data
train_pred = predict(pcr_m, trainreal, ncomp = 5)
test_pred = predict(pcr_m, testreal, ncomp = 5)
